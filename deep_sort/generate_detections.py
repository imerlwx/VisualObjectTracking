...
def _run_in_batches(f, data_dict, out, batch_size):
    ...
    s, e = 0, 0  # left and right boundaries of each batch
...
class ImageEncoder(object):
    ...
    checkpoint_filename : str
        A model that could output features of the patch
    ...
    Attributes
    ----------
    session : tf.compat.v1.Session object
        Launch the graph in a session
    input_var : tensor
        The input tensor with name `input_name`
    output_var : tensor
        The output tensor with name `output_name`
    feature_dim : int
    ...
    def __init__(self, checkpoint_filename, input_name="images", output_name="features"):
        # Define an object that encapsulates the environment in which Operation
        # are executed, and data objects are evaluated. TensorFlow requires a 
        # session to execute an operation and retrieve its calculated value.
